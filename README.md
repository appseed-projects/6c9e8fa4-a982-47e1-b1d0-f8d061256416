...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-26 07:14`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6c9e8fa4-a982-47e1-b1d0-f8d061256416.git
$ cd 6c9e8fa4-a982-47e1-b1d0-f8d061256416
```
